        ...
        <div class="div2 w-100" id="club2">
            ...
            <nav class="navbar navbar-light">
                <form class="form-inline">
                    <input class="form-control mr-sm-2" type="search" placeholder="Enter Club Name" aria-label="Search"
                        id="myinput">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="Clubs.php">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="Registration-no" name="regno" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="recipient-name" class="col-form-label">Name:</label>
                                            <input type="text" class="form-control" id="recipient-name" name="rname" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="recipient-email" class="col-form-label">Email:</label>
                                            <input type="email" class="form-control" id="recipient-email" name="remail" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="club-name" class="col-form-label">Club name:</label>
                                            <input type="text" class="form-control" id="club-name" name="cname" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="domain-name" class="col-form-label">Domain:</label>
                                            <input type="text" class="form-control" id="domain-name" name="dname" required>
                                        </div>
                                        <div class="mb-3">
